...
class Order  extends BaseModel
{
	...
	public $ThoiDiemGiaoHang;
	public $DiaDiemGiaoHang;
	public $TenNguoiNhan;
	public $GhiChu;
	public $TinhTrang;
	public $_table;
	...
	public  function getAll($Condition = NULL, $pageLimit, $rowPerPage){
		...
		$sqlLimit = " GROUP BY idDH ORDER BY idDH";
...
print_r($sql);
	...
	public function search($Condition = NULL, $pageLimit, $rowPerPage){
		return self::getAll($Condition = NULL, $pageLimit, $rowPerPage);
	}
}