...
<form action="" method="post" name="fForm">
		...
		<?php $id = $post->id ;?>
			<tr>
				...
				<td align="center">	
					...
					<img src="/helper/admin/img/icons/edit.png" title="Sửa" width="16" height="16"></a>
					<a href="javascript:editPage(<?php echo $id;?>,'deltete','delete.php')"><img src="/helper/admin/img/icons/delete.png" title="Xóa" width="16" height="16"></a>
				</td>
			</tr>
		<?php endforeach; ?>
		<?php } else {?>
	...
	<table border="1px">
		<tbody><tr><td class="paging border_none"><?php if ($PageList) echo $PageList; ?></td></tr></tbody>
	</table>
